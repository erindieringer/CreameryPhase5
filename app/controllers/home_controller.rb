class HomeController < ApplicationController
  ...
  def home
    ...
    @shifts_today = Shift.for_next_days(0).by_store.paginate(page: params[:page]).per_page(5)
    @active_employees = Employee.active.regulars.all.paginate(page: params[:page]).per_page(5)
    @active_managers = Employee.active.managers.all.paginate(page: params[:page]).per_page(5)
